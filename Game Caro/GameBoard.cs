...
namespace Game_Caro
{
    class GameBoard
    {
        ...
        public GameBoard(Panel board, TextBox PlayerName, PictureBox Avatar)
        {
            ...
            {
                new Player("Người chơi A", Image.FromFile(Application.StartupPath + "\\images\\O_caro.jpg"),
                                        Image.FromFile(Application.StartupPath + "\\images\\O_caro.jpg")),

                new Player("Người chơi B", Image.FromFile(Application.StartupPath + "\\images\\X_caro.jpg"),
                                   Image.FromFile(Application.StartupPath + "\\images\\X_caro.jpg"))
            };       
        }      
        #endregion
